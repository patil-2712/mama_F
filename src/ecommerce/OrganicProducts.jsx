      ...
      <section className="organic-products-section">
        <div className="organic-products-container">
          <div className="organic-section-header">
            <h2 className="organic-section-title">Organic Products</h2>
          </div>
        ...
        <div className="organic-products-container">
          ...
          <div className="organic-products-grid">
            {products.map((product) => (
              ...
              >
                {/* Image Container - Same radius all corners */}
          ...
          <div className="organic-modal">
            ...
            <div className="organic-modal-content-wrapper">
              ...
              <div className="organic-modal-details-section">
                ...
                <div className="organic-modal-rating">
                  {'⭐'.repeat(Math.round(selectedProduct.rating || 0))}
                  <span className="organic-modal-rating-count">({selectedProduct.reviews || 0} reviews)</span>
                </div>
                ...
                <div className="organic-modal-stock-status">
                  <span className={`organic-stock-indicator ${selectedProduct.inStock ? 'in-stock' : 'out-of-stock'}`}>
                ...
                {selectedProduct.quantity && (
                  <div className="organic-modal-quantity-info">
